        ...
        <div className="contact-content relative flex min-h-[100svh] w-full flex-col items-center justify-between pt-12">
          ...
          <div className="flex w-full justify-between py-12">
            <div>
              ...
              <Link
                href="https://github.com/muhamadhusnimubarok"
                target="_blank"
            ...
            <div className="flex flex-col items-end">
              ...
              <div className="flex items-center gap-x-2">
                <ContactLink
                  href="https://www.instagram.com/mhusniim__/"
                  label="Instagram"
                  icon={
                ...
                />
                <ContactLink
                  href="mailto:muhamadhusnimubarok11@gmail.com"
                  label="Email"
                  icon={
                ...
                />
                <ContactLink
                  href="https://www.linkedin.com/in/mhusni-mubarok-4326432b5/"
                  label="LinkedIn"
                  icon={
