      ...
      <div className="mx-auto flex w-[90%] flex-col items-start justify-center lg:max-w-[1212.8px]">
        ...
        <div className="mx-auto flex w-full flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
          <div className="lg:mg-16 mb-10 flex w-full flex-col gap-4 text-[18px] font-medium leading-relaxed tracking-wide md:mb-16 md:gap-6 md:text-[20px] md:leading-relaxed lg:max-w-[90%] lg:text-base">
            <AnimateParagraph
              paragraph="Saya adalah seorang siswa dari SMK Wikrama Bogor dengan fokus pada Pengembangan Perangkat Lunak dan Gim. Saya adalah pribadi yang menyukai hal-hal baru, teliti , tekun, dan disiplin, selalu memperhatikan detail dalam setiap proyek yang saya kerjakan.."
              delay={1.5}
            />
            <AnimateParagraph
              paragraph="Saya memiliki ketertarikan yang sangat tinggi dengan dunia coding saya sudah menguasai bahasa pemrograman seperti PHP, HTML, CSS, JavaScript, dan MySQL, saya berkomitmen untuk terus mengembangkan skill keterampilan teknis saya."
              delay={1.8}
            />
          </div>
          ...
          <div className="mb-24 flex w-full flex-col gap-4 leading-relaxed tracking-wide sm:mb-32 md:mb-40 md:gap-6 md:leading-relaxed lg:mb-16 lg:max-w-[90%]">
            ...
            <div className="flex flex-col gap-4 md:gap-3">
              <AnimateHeading title="Backend Tools" delay={1.6} />
              <AnimateBody
                text=" PHP (Laravel), SQL, Python."
                delay={2}
                className="text-sm"
              />
            </div>
