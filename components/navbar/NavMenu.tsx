          ...
          <div className="flex gap-x-2 px-[clamp(1.25rem,3vw,2.5rem)] text-base">
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1}
                link="https://github.com/muhamadhusnimubarok"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.2}
                link="https://www.linkedin.com/in/mhusni-mubarok-4326432b5/"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.4}
                link="https://www.instagram.com/mhusniim__/"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
