...
export const metadata: Metadata = {
  title: {
    template: "Coding with Husni | %s",
    default: "Coding with Husni | Frontend Developer",
  },
  description:
  ...
  openGraph: {
    ...
    siteName: "Coding with Husni",
    images: [
      {
        url: "/public/images/images.jpg",
        width: 1000,
        height: 1200,
      },
    ],
